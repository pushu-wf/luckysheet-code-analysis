	...
	themeConfig: {
		...
		sidebar: [
			...
			},
			{
				...
				text: "第 3 章：关键技术剖析",
				items: [
					{ text: "3.1 表格渲染", link: "/chapter3/controller.md" },
					{ text: "3.2 图表系统", link: "/chapter3/controller.md" },
					{ text: "3.3 公式解析与执行", link: "/chapter3/controller.md" },
					{ text: "3.4 协同实现", link: "/chapter3/controller.md" },
				],
			},
			{
				collapsed: true,
				text: "第 4 章：拓展实践",
				items: [
					{ text: "4.1 自定义菜单", link: "/chapter4/controller.md" },
					{ text: "4.2 自定义请求头", link: "/chapter4/controller.md" },
					{ text: "4.3 拓展VChart", link: "/chapter4/controller.md" },
				],
			},
			{
				collapsed: true,
				text: "第 5 章：附录",
				items: [
					{ text: "5.1 配置说明", link: "/chapter5/apis.md" },
					{ text: "5.2 API 参考", link: "/chapter5/apis.md" },
					{ text: "5.3 教程与资源", link: "/chapter5/apis.md" },
					{ text: "5.4 常见问题", link: "/chapter5/apis.md" },
				],
			},
		],
